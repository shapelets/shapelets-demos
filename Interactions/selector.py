...
# option_select is a list, where 0 is the index of the selected item and 1 is its value
def change_label(option_selected) -> str:
    return "Selected option " + option_selected[1]
