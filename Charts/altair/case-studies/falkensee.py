...
app = DataApp("Falkensee", version=(0,1))

text = app.text("""
This example is a reproduction of the Falkensee plot
""")
app.place(text)
...
spec = rect + line + point

# Create altair chart widget
altair_chart = app.altair_chart(title='Falkensee', chart=spec)
