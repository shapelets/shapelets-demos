...
app = DataApp("Isotype Visualization", version=(0,1))
...
spec = alt.Chart(source).mark_point(filled=True, opacity=1, size=100).encode(
    alt.X('x:O', axis=None),
...
altair_chart = app.altair_chart(title='Isotype Visualization', chart=spec)
